...
function armarGroup3D(elemento, modulo, geometry, matCfg) {
    ...
    */
    ...
    /*
        ...
        sólido/alambre/normales, overlay de malla)
        sin que este módulo (galeria-escena.js)
        necesite saber nada de paneles ni de lil-gui.

        IMPORTANTE si algo (por ejemplo
        galeria-panel-parametros.js) reemplaza la
        geometría de las mallas en vivo: el nuevo bbox
        puede tener un centro X/Z distinto, así que
        "pivote.position" y el offset de las mallas
        (mallaFrontal/mallaTrasera.position, seteados
        arriba) habría que recalcularlos con el mismo
        criterio, o el pivote de rotación queda
        desalineado del nuevo bbox.
    */
    ...
    /*
        ...
        material (por ejemplo al cambiar a "alambre" o
